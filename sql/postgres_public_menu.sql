...
INSERT INTO public.menu (id, parent, name, sort, route) VALUES (3, 2, '课程发布', 1, '/course_manage');
INSERT INTO public.menu (id, parent, name, sort, route) VALUES (4, 2, '学员管理', 2, '/signed');
